...
# For Buxar Pilot
AGGREGATOR_SMS_NO = '9505276111'
#For Production
# EXOTEL_MI_LINE = '01139585707'
# For Buxar Pilot
EXOTEL_MI_LINE = '01139585945'
...
agg_sms_initial_line = 'लूप मंडी मास्टर (%s) को कॉल करने के लिए धन्यवाद।\n'%(AGGREGATOR_SMS_NO)
agg_sms_initial_line_with_content = 'लूप मंडी मास्टर (%s)\n'%(AGGREGATOR_SMS_NO)
fasal = 'फसल'
agg_sms_no_price_for_combination = 'रेट उपलब्ध नही है\n'
agg_sms_no_price_available = 'इस मंडी और फसल के लिए पिछले तीन दिनो के रेट उपलब्ध नही है।\n\nकिसी भी फसल का रेट जानने के लिए %s पर मिस कॉल या SMS द्वारा फसल का कोड डालें।'%(AGGREGATOR_SMS_NO)
agg_sms_no_price_all_mandi = '%s\nमाफ़ कीजिए, इस फसल का पिछले तीन दिनो का रेट उपलब्ध नही है।\n\nकिसी भी फसल का रेट जानने के लिए %s पर मिस कॉल या SMS द्वारा फसल का कोड डालें।'%('%s',AGGREGATOR_SMS_NO)
agg_sms_no_price_crop_mandi = '%s का %s मंडी मे पिछले तीन दिनो के रेट उपलब्ध नही है।\n\nकिसी भी फसल का रेट जानने के लिए %s पर मिस कॉल या SMS द्वारा फसल का कोड डालें।'%('%s','%s',AGGREGATOR_SMS_NO)
...
BUXAR_PILOT_MANDI_ID = (134,152,133,16,151,14,188,150)
